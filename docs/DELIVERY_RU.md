...
Исторический отчёт версии 0.5. Текущие изменения: [федерация v0.7](FEDERATION_DELIVERY_RU.md) и [вычислительный эксперимент по структурной пластичности](MORPHOGENESIS_MODEL_RU.md). Приведённые ниже результаты датированы 18 сентября и не являются итоговой проверкой версии 0.7.
